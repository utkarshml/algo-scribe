  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isUser ? "bg-gradient-to-br from-purple-500 to-pink-500 text-white" : "bg-gradient-to-br from-indigo-500 to-purple-500 text-white"
      )}>
        {isUser ? (
      ...
      <div className={cn(
        ...
        <div style={{width : "-webkit-fill-available"}} className={cn(
          ...
          isUser 
            ...
            : "bg-[rgb(23,22,22)] border text-white  border-[rgb(46,47,47)] rounded-bl-md"
        )}>
          <div className={cn(
